  ...
  return (
    ...
    <>
      ...
      <div class='age-insurance'>
        ...
        <Dropdown impact={props.impact} setImpact={props.setImpact} correctedCountyFetch={correctedCountyFetch} countyStories={countyStories} setCountyStories={setCountyStories} />
      </div>
      <div>
        {dataFetched
          ? [
